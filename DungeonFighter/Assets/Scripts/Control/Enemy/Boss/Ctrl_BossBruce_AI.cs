...
namespace Control
{
    public class Ctrl_BossBruce_AI : BaseControl
    {
        ...
        private Ctrl_BossBruce_Animation _myAnimation;                                  //自身动画系统脚本
        ...
        void Awake()
        {
            ...
            _myAnimation = GetComponent<Ctrl_BossBruce_Animation>();
        ...
        {
            yield return new WaitForSeconds(_myAnimation.ac_Blare.length);
