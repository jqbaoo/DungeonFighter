...
namespace Control
{
    public class Ctrl_Archer_AI : BaseControl
    {
        ...
        public float floThinkInterval = 5f;                                             //思考间隔时间
        ...
        void Start()
        {
            ...
            floAttackDistance = UnityHelper.GetInstance().GetRandomNum(10, 15);
            floCordonDistance = UnityHelper.GetInstance().GetRandomNum(16, 20);
